                ...
                <div id="info_shipping" class="container">
                  <div class="container_items" style="border-top:solid 1px #C0C0C0;">
                        ...
                        <div class="container_body">
                            ...
                            <div class="container_item_right">
                                <label><input class="radio" type="radio" name="radio_phone" value="갤럭시s21" checked>
                                갤럭시S21</label>
                                <label><input class="radio" type="radio" name="radio_phone" value="갤럭시s21+" >
                                갤럭시S21+</label>
                                <label><input class="radio" type="radio" name="radio_phone" value="갤럭시s21울트라">
                                갤럭시S21울트라</label>
                            </div>
                        </div>
                        <div class="container_body">
                            ...
                            <div class="container_item_right">
                              <label><input class="radio" type="radio" name="radio_service" value="sk" checked>
                              SK</label>
                              <label><input class="radio" type="radio" name="radio_service" value="kt" >
                              KT</label>
                              <label><input class="radio" type="radio" name="radio_service" value="lg">
                              U+</label>
                            </div>
                        </div>
                        <div class="container_body">
                  ...
                  <label><input class="radio" type="radio" name="radio_memory" value="512GB">
                              <span class="style1">512GB S21울트라만 선택가능</span> </label>
                            </div>
                        </div>
                    </div>
                    <span class="style1">
